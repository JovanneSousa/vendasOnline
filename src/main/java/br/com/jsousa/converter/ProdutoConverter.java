package br.com.jsousa.converter;
...
@Named
@FacesConverter(value = "produtoConverter", forClass = Cliente.class)
public class ProdutoConverter implements Converter {
	
	private static final String key = "br.com.jsousa.converter.ProdutoConverter";
